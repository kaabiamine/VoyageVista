...
<?php
include_once 'C:\xampp\htdocs\VOYAGEVISTA\Controller\DestinationsC.php'; // Fixed path
require_once 'C:\xampp\htdocs\VOYAGEVISTA\Model\Destination.php'; // Fixed path
                    ...
                    <?php foreach ($listeDestinations as $destination): ?>
                      <tr>
                        ...
                        <td class="align-middle">
                          <a href="?edit=<?php echo $destination['idD']; ?>" class="btn btn-sm btn-secondary me-2"
                            data-toggle="tooltip" data-original-title="Edit destination">
                            Edit
                          </a>
                          <a href="process_destination.php?delete=<?php echo $destination['idD']; ?>"
                            class="btn btn-sm btn-danger" data-toggle="tooltip" data-original-title="Delete destination">
                            Delete
                          </a>
                        </td>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <form method="POST" action="process_destination.php" onsubmit="return validateForm()">
                <div class="mb-3">
                    <label for="Nom_destination" class="form-label">Nom_destination</label>
                    <input type="text" class="form-control" id="Nom_destination" name="Nom_destinatio" value="<?php echo isset($destinationToEdit) ? $destinationToEdit->getNom_destinatio() : ''; ?>">
                </div>
                <div class="mb-3">
                    <label for="Description" class="form-label">Description</label>
                    <input type="text" class="form-control" id="Description" name="Description" value="<?php echo isset($destinationToEdit) ? $destinationToEdit->getDescription() : ''; ?>">
                </div>
...
<script>
          ...
          <?php if (isset($_GET['edit'])): ?>
            <?php $destinationToEdit = $destinationC->getDestinationById($_GET['edit']); ?>
            <form method="POST" action="process_destination.php">
              <input type="hidden" name="id" value="<?php echo $destinationToEdit['idD']; ?>">
              <div class="mb-3">
                <label for="Description" class="form-label">Description</label>
                <input type="text" class="form-control" id="Description" name="Description"
                  value="<?php echo $destinationToEdit['Description']; ?>">
              </div>
              <div class="mb-3">
                <label for="Nom_destinatio" class="form-label">Nom_destinatio</label>
                <input type="text" class="form-control" id="Nom_destinatio" name="Nom_destinatio"
                  value="<?php echo $destinationToEdit['Nom_destinatio']; ?>">
              </div>
