...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    $id = $_GET['id'];
    $reclamation = $reclamationControllerFront->getReclamationById($id);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $reclamationControllerFront->updateReclamation($id,new DateTime($_POST['date']), $_POST['sujet'],$_POST['description']);
