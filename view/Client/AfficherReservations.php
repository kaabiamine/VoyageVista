...
$reservations = $reservationController->getReservationsByUserID($user1);
?>
...
<div class="container-fluid bg-light service py-5">
    <div class="text-center mt-4">
        ...
        <a class="btn btn-outline-success rounded-pill py-3 px-5" href="Reservation.php">Add Reservation</a>
    </div>
