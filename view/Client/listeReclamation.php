...
try {
    ...
    $reclamationControllerFront = new ReclamationControllerFront($db);
    $reclamations = $reclamationControllerFront->getReclamations($userId); // Vous pouvez dynamiser cette valeur selon l'utilisateur connecté
} catch (Exception $e) {
...
<div class="container text-center py-5" style="max-width: 900px;">
    ...
    <ol class="breadcrumb justify-content-center mb-0">
        ...
        <li class="breadcrumb-item active text-white">Liste des réclamations</li>
        ...
        <div class="container-fluid packages py-5">
            <div class="container py-5">
                <div class="mx-auto text-center mb-5" style="max-width: 900px;">
                    <h5 class="section-title px-3">Liste de mes réclamations </h5>
            ...
            <?php foreach ($reclamations as $reclamation): ?>
                ...
                <a href="editReclamation.php?id=<?= $reclamation['idReclamation']; ?>" class="btn btn-primary">
                    <i class="fas fa-edit"></i>
                </a>
                <!-- Bouton de suppression -->
                <a href="deleteReclamation.php?id=<?= $reclamation['idReclamation']; ?>" class="btn btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette réclamation ?');">
