...
$error = "";
$userId = $_SESSION['user']['id'];  // Assurez-vous que l'utilisateur est bien identifié
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST["date"], $_POST["sujet"], $_POST["description"])) {
    ...
    if ($submittedDate->format('Y-m-d') !== $currentDate->format('Y-m-d')) {
        ...
        $error = "Le sujet doit contenir uniquement des lettres, des points, des virgules et des espaces.";
        ...
        try {
            ...
            $reclamationControllerFront->addReclamation($reclamation);
            header('Location: listeReclamation.php'); // Redirection vers la liste des réclamations
            exit;
        } catch (Exception $e) {
            $error = "Erreur lors de l'ajout de la réclamation : " . $e->getMessage();
        }
    }
}
...
<div class="container text-center py-5" style="max-width: 900px;">
    <h3 class="text-white display-3 mb-4">Réclamation</h3>
