...
try {
    ...
    $reclamations = $reclamationController->getReclamations(1); // Vous pouvez dynamiser cette valeur selon l'utilisateur connecté
} catch (Exception $e) {
        ...
        <div class="container-fluid bg-breadcrumb">
            <div class="container text-center py-5" style="max-width: 900px;">
                ...
                <ol class="breadcrumb justify-content-center mb-0">
                    ...
                    <li class="breadcrumb-item active text-white">Liste de mes réclamations </li>
